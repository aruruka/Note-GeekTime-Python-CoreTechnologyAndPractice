...
async def main():
    ...
    all_movies = init_soup.find('dev', id="showing-soon")
    for each_movie in all_movies.find_all('div', class ="item"):
...
print("time elapse using map: {}".format(
    end_using_coroutine - start_using_coroutine))
