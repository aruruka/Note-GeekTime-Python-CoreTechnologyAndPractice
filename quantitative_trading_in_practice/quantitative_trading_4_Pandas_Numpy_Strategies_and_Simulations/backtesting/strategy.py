...
import numpy as np
import abc
from quantitative_trading_in_practice.quantitative_trading_4_Pandas_Numpy_Strategies_and_Simulations.utils import assert_msg, crossover, SMA
...
class Strategy(metaclass=abc.ABCMeta):
    ...
    def I(self, func: Callable, *args) -> np.ndarray:
        ...
        assert_msg(value.shape[-1] ==
                   len(self._data.Close), '指示器长度必须和data长度相同')
